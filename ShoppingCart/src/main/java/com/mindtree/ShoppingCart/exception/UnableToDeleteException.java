 ...
 *
 */
public class UnableToDeleteException extends ShoppingCartDaoException {
	 ...
	 */
	public UnableToDeleteException(String message, Throwable cause, boolean enableSuppression,
